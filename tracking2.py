...
def main(argv):
    ...
    out = cv2.VideoWriter('output_video/final_videos/top_view.mp4', cv2.VideoWriter_fourcc(*'H264'), fps, (frame_width, frame_height))
    ...
    # Release video capture and writer objects and destroy windows after ESC is pressed
    cap.release()
    out.release()
